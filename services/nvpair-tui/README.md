...
| **Proxies** | The Ollama and OpenAI-compatible (LM Studio, vLLM, SGLang) reverse proxies: status, discovered upstreams, select a node (`enter`/`a`), set the listen port (`p`). |

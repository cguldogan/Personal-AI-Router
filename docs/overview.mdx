...
- **Engine** — the local inference server that runs models: Ollama, LM Studio,
  vLLM, or SGLang. PAIR can install, start, stop, and update an engine, or adopt
  one you already run yourself.
...
- Ollama-compatible and OpenAI-compatible routing proxies. The
  OpenAI-compatible one fronts LM Studio, vLLM, and SGLang.

...
run models. Today that means Ollama, LM Studio, or vLLM on a given machine. PAIR
...
- If Ollama, LM Studio, or vLLM is already running on the machine, PAIR can
  **adopt** that install instead of downloading another copy. Adoption helps when
  the usual engine port is already in use.
